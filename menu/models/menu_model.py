...
class QRMenu(models.Model):
    ...
    qr_code = models.ImageField(upload_to='qr_menu/', null=True, blank=True) # to create menu first then generate the qr image
...
class MenuSection(models.Model):
    ...
    order = models.PositiveIntegerField(default=0) # in which order sections will be shows
...
class MenuItem(models.Model):
    ...
    order = models.PositiveIntegerField(default=0) # to show which item first
    available = models.BooleanField(default=True)
